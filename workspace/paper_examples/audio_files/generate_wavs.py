...
amp = 0.8
s1 = amp*generate_saw(f1)
s2_e = amp*generate_saw(f2_e)
s2_j = amp*generate_saw(f2_j)
s3_e = amp*generate_saw(f3_e)
s3_j = amp*generate_saw(f3_j)
s4_e = amp*generate_saw(f4_e)
s4_j = amp*generate_saw(f4_j)
...
s1 = amp*generate_square(f1)
s2_e = amp*generate_square(f2_e)
s2_j = amp*generate_square(f2_j)
s3_e = amp*generate_square(f3_e)
s3_j = amp*generate_square(f3_j)
s4_e = amp*generate_square(f4_e)
s4_j = amp*generate_square(f4_j)
